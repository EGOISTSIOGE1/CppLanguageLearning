/*************************************************************************
	> File Name: 11.student_system.c
	> Author: TaoJY
	> Mail: taojy@toramon.com
	> Created Time: Sun 07 Jan 2024 06:03:21 PM CST
 ************************************************************************/
...
void add_a_student() {
	printf("add new a item : (name, age, class, height)\n");
	printf("mysql > ");
	scanf("%s%d%d%lf", 
		stus[scnt].name, 
		&stus[scnt].age, 
...
void modify_a_student() {
	...
	printf("modity a item : (name, age, class, height)\n");
	printf("mysql > ");
	scanf("%s%d%d%lf", 
		stus[id].name, 
		&stus[id].age, 
